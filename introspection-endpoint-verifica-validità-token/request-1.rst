...
La richiesta di Introspection Endpoint definisce un metodo per ottenere
informazioni aggiuntive riguardanti un access_token, presso
l'entità che l'ha emesso (OP).
